...
mixin _$HomeController on _HomeControllerBase, Store {
  final _$collapseMenuAtom = Atom(name: '_HomeControllerBase.collapseMenu');
  ...
  final _$_HomeControllerBaseActionController = ActionController(name: '_HomeControllerBase');

  @override
  void selectcollapseMenu() {
    final _$actionInfo =
        _$_HomeControllerBaseActionController.startAction(name: '_HomeControllerBase.selectcollapseMenu');
    try {
